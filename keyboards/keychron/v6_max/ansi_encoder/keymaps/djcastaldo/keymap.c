...
// for trackign if leader sequence is started
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [MAC_BASE] = LAYOUT_ansi_109(
        KC_ESC,   KC_F1,    KC_F2,    KC_F3,    KC_F4,    KC_F5,    KC_F6,    KC_F7,    KC_F8,    KC_F9,    KC_F10,   KC_F11,   KC_F12,  DUAL_ENCPUSH,  KC_SNAP,  KC_SIRI,  RGB_MOD,  DUAL_F13,   DUAL_F14,   CALCPRO,   LOCKSCR,
        KC_GRV,   KC_1,     KC_2,     KC_3,     KC_4,     KC_5,     KC_6,     KC_7,     KC_8,     KC_9,     KC_0,     KC_MINS,  KC_EQL,     BSPCFAST,    KC_INS,   KC_HOME,  KC_PGUP,  KC_NUM,   KC_PSLS,  KC_PAST,  DUAL_PMNS,
        ...
        KC_LCTL,  KC_LOPT, KC_LCMD,                               KC_SPC,                                 KC_RCMD, TD(ROPT_OSL), FNLAYER, TD(RCTL_OSL),    KC_LEFT,  KC_DOWN,  KC_RGHT,  KC_P0,              KC_PDOT,  KC_PENT),
    [FN_LAYER] = LAYOUT_ansi_109(
        _______,  _______,  _______,  KC_MCTRL, KC_LNPAD, _______,  _______,  KC_MPRV,  KC_MPLY,  KC_MNXT,  _______,  _______,  _______,     F_ZOOMR,    SSMENU,  MOD_SIRI,  GNEWS,  DM_REC1,  DM_REC2,  DM_PLY1,  DM_PLY2,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  ARROW,  WAVE,    _______,    LLOCK,  V_TAB_PRV,  V_WSPC_PRV,  SECRET10,  SECRET11,  SECRET12,  SECRET13,
        _______,  _______,  _______,  SECRET1,  SECRET8,  TIMESTAMP,  _______,  UNICODE,  _______,  _______,  _______,  _______,  _______,    _______,    _______,  V_TAB_NXT, V_WSPC_NXT,  SECRET1,  SECRET2,  SECRET3,
        _______,  SECRET4, _______,  _______,  SECRET7,  _______,  _______,  _______,  _______,  QK_LEAD,  _______,  _______,              _______,                                  SECRET4,  SECRET5,  SECRET6,  _______,
        SFTLAYER,            _______,  SECRET10,  SECRET11,  _______,  _______,  _______,  _______,  _______,  _______,  _______,              SFTLAYER,              _______,            SECRET7,  SECRET8,  SECRET9,
        MO(CTL_LAYER),  MO(OPT_LAYER),  _______,                                _______,              _______,  MO(OPT_LAYER),  _______,    MO(CTL_LAYER),    _______,  _______,  _______,  TIMESTAMP,       _______,  _______),
    ...
    [SFT_LAYER] = LAYOUT_ansi_109(
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    DUAL_UNIPUSH,    E_SSHOT,  E_MIC,  E_BULB,  E_SMILE, E_SMIRK,  E_ASTON,  E_SAD,
        ...
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    E_I,      E_OK,   _______,  _______,  _______,    _______,    E_TRASH,  E_CMARK,  E_QMARK,  E_FLAGUS,  E_FLAGPI,  E_GLOBE,
        _______,  E_STAR,  E_SGLASS,  _______,  _______,  _______,   E_HASH,  _______,    E_KB,   _______,  _______,  _______,              _______,                                  E_PIZZA,  E_BURGER,  E_CHICKEN,  E_TACO,
    ...
    [CTL_LAYER] = LAYOUT_ansi_109(
        _______,  _______,  _______,  _______, _______, KB_RESET,  _______,  _______,  _______,  _______,  _______,  _______,  _______,     PENT_ENCPUSH,    QK_LOCK,  _______,  RGB_MOD,  _______,  SECRET0,  _______,  _______,
        _______,  BT_HST1,  BT_HST2,  BT_HST3,  P2P4G,    _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,    _______,    LLOCK,  FJLIGHT,  _______,  _______,  _______,  _______,  _______,
        _______,  _______,  _______,  _______,  _______,  _______,  _______,  _______,  KC_UP,  _______,  _______,  _______,  _______,    _______,    _______,  HROWLIGHT,  _______,  _______,  _______,  _______,
        _______,  _______, _______,  _______,  _______,  _______,  _______,  KC_LEFT,  KC_DOWN,  KC_RIGHT,  _______,  _______,              _______,                                  _______,  _______,  _______,  _______,
        _______,            _______,  _______,  _______,  _______,  BAT_LVL,  NK_TOGG,  _______,  _______,  _______,  _______,              _______,              RGB_MOD,            _______,  _______,  _______,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,    _______,    RGB_SPD,  RGB_RMOD,  RGB_SPI,  _______,            _______,  _______),
    [OPT_LAYER] = LAYOUT_ansi_109(
        FORCEQUIT,  _______,  _______,  VI_REPLACE, _______, GIT_CHKOUT,  _______,  _______,  _______,  GIT_ADD,  GIT_COMMIT,  _______,  GIT_PUSH,     DUAL_ENCPUSH2,    QK_LOCK,  _______,  NEWFINDER,  FHOME,  FAPPS,  FDOCS,  FDOWNL,
        CMDGRAVE,  SOC1,  SOC2,  SOC3,  SOC4,    SOC5,  SOC6,  SOC7,  SOC8,  SOC9,  SOC0,  _______,  _______,    _______,    LLOCK,  V_TAB_PRV,  SCMDGRAVE,  FQLOOK,  FINSPECT,  FVHIDDEN,  FSTATBAR,
        MK_ACCEL2,  FQLOOK,  _______,  _______,  _______,  TIMESTAMP,  _______,  KC_MS_BTN1,  KC_MS_UP,  _______,  _______,  _______,  _______,    TOVERVIEW,    FDELETE,  V_TAB_NXT,  CMDGRAVE,  _______,  _______,  _______,
        _______,  _______, _______,  _______,  _______,  _______,  _______,  KC_MS_LEFT,  KC_MS_DOWN,  KC_MS_RIGHT,  TD(MOUSE_ACCEL),  _______,        _______,                    BACKDIR,  HOMEDIR,  SECRET21,  _______,
        MK_ACCEL0,            _______,  _______,  _______,  _______,  _______,  MK_REL,  MK_HOLD,  CURSORL,  CURSORR,  FSTATBAR,              _______,              _______,            LSLTRAH,  GIT_LOG,  SECRET25,
        _______,  _______,  _______,                                _______,                                _______,  _______,  _______,    _______,    _______,  _______,  _______,  TIMESTAMP,            _______,  _______),
    [LOCK_LAYER] = LAYOUT_ansi_109(
        KC_NO,  KC_NO,  KC_NO,  KC_NO, KC_NO, KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,     KB_UNLOCK,    KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,  KC_NO,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case GNEWS:
	   ...
	   // open browser tab to google news 
    	   send_string(SS_LCMD(SS_TAP(X_L)) SS_DELAY(150) "news." SS_DELAY(50) "google" SS_DELAY(50) ".com" SS_DELAY(50) SS_LOPT(SS_TAP(X_ENT)));
	}
    	break;
    case GIT_ADD:
    	if (record->event.pressed) {
    ...
    case PENT_ENCPUSH:
    	if (record->event.pressed) {
            ...
            if (mods & MOD_MASK_SHIFT) {
                ...
                rgblight_sethsv(rgblight_get_hue(), 235, rgblight_get_val());
            }
            // otherwise do toggle 
            else {
                rgblight_toggle(); 
...
void leader_end_user(void) {
    ...
    else if (leader_sequence_three_keys(KC_Q, KC_C, KC_K)) {  // qmk compile keychron firmware
...
bool rgb_matrix_indicators_advanced_user(uint8_t led_min, uint8_t led_max) {
	...
	uint8_t layer = get_highest_layer(layer_state);
        if (layer > 0) {
            for (uint8_t row = 0; row < MATRIX_ROWS; ++row) {
			    ...
			    break;
		        case FN_LAYER:	
			    if (index == 16 || index == 17) { // macro recording keys
	    ...
	    if (layer == FN_LAYER) {
    	      rgb_matrix_set_color(78, RGB_ORANGE); // left shift 
    	      rgb_matrix_set_color(89, RGB_ORANGE); // right shift 
    	      rgb_matrix_set_color(94, RGB_RED);    // left ctrl
    	      rgb_matrix_set_color(95, RGB_YELLOW); // left option
    	      rgb_matrix_set_color(99, RGB_YELLOW); // right option
    	      rgb_matrix_set_color(101, RGB_RED);   // right ctrl
	    }	
	        ...
	        switch (layer) {
	        case SFT_LAYER:
                    rgb_matrix_set_color(78, RGB_ORANGE); // lshift 
                    rgb_matrix_set_color(89, RGB_ORANGE); // rshift
                    rgb_matrix_set_color(97, RGB_ORANGE); // space
		    break;
	        case CTL_LAYER:
                    rgb_matrix_set_color(94, RGB_RED);    // lctrl
                    rgb_matrix_set_color(101, RGB_RED);   // rctrl
                    rgb_matrix_set_color(97, RGB_RED);    // space
		    break;
	        case OPT_LAYER:
                    rgb_matrix_set_color(95, RGB_YELLOW); // lopt
                    rgb_matrix_set_color(99, RGB_YELLOW); // ropt
                    rgb_matrix_set_color(97, RGB_YELLOW); // space
		    break;
	        case LOCK_LAYER:
    	            rgb_matrix_set_color(19, RGB_RED);    // X
    	            rgb_matrix_set_color(0, RGB_RED);     // Esc 
		    break;
	        default:	
                    rgb_matrix_set_color(61, RGB_GREEN);  // caps
                    rgb_matrix_set_color(100, RGB_GREEN); // fn
                    rgb_matrix_set_color(97, RGB_GREEN);  // space
   		    break;
	        }
            } 
        }
        // default layer color settings
            ...
            rgb_matrix_set_color(0, 255, 255, 255);  // esc
    	    rgb_matrix_set_color(1, 234, 234, 255);  // f1
    	    rgb_matrix_set_color(2, 234, 234, 255);  // f2
    	    rgb_matrix_set_color(3, 234, 234, 255);  // f3
    	    rgb_matrix_set_color(4, 234, 234, 255);  // f4
    	    rgb_matrix_set_color(5, 0, 255, 0);      // f5
    	    rgb_matrix_set_color(6, 255, 255, 0);    // f6
    	    rgb_matrix_set_color(7, 255, 255, 0);    // f7
    	    rgb_matrix_set_color(8, 255, 255, 0);    // f8
    	    rgb_matrix_set_color(9, 255, 255, 0);    // f9
    	    rgb_matrix_set_color(10, 234, 234, 255); // f10
    	    rgb_matrix_set_color(11, 255, 0, 0);     // f11
    	    rgb_matrix_set_color(12, 234, 234, 255); // f12
    	    rgb_matrix_set_color(13, 234, 234, 255); // screenshot
    	    rgb_matrix_set_color(14, 234, 234, 255); // siri
    	    rgb_matrix_set_color(15, 234, 234, 255); // rgb
    	    rgb_matrix_set_color(16, 234, 234, 255); // circle
    	    rgb_matrix_set_color(17, 234, 234, 255); // triangle
    	    rgb_matrix_set_color(18, 234, 234, 255); // square
    	    rgb_matrix_set_color(19, 255, 0, 0);     // X
            if (!host_keyboard_led_state().caps_lock) {
    	      rgb_matrix_set_color(61, RGB_ORANGE);  // caps 
	    }
            // if caps lock, color caps alpha keys
            else {
               for (uint8_t i = led_min; i < led_max; i++) {
                 if ((i > 41 && i < 52) || (i > 61 && i < 71) || (i > 78 && i < 86)) {
	    ...
	    if (is_caps_word_on())
            {
              ...
              for (uint8_t i = led_min; i < led_max; i++) {
                if (i == 31 || (i > 41 && i < 52) || (i > 61 && i < 71) || (i > 78 && i < 86)) {
                   rgb_matrix_set_color(i, RGB_RED);
                }
              }
    	      rgb_matrix_set_color(78, 255, 255, 255); // turn left shift white when caps_word is active
    	      rgb_matrix_set_color(89, 255, 255, 255); // turn right shift white when caps_word is active
	    }
            else if (!host_keyboard_led_state().caps_lock) { // if not caps word, nor caps lock, then f and j are lighter color 
	      if (hrow_light) {
    	          rgb_matrix_set_color(62, 0, 255, 0); // a
    	          rgb_matrix_set_color(63, 0, 255, 0); // s
    	          rgb_matrix_set_color(64, 0, 255, 0); // d
    	          rgb_matrix_set_color(65, 0, 255, 0); // f
    	          rgb_matrix_set_color(68, 0, 255, 0); // j
    	          rgb_matrix_set_color(69, 0, 255, 0); // k
    	          rgb_matrix_set_color(70, 0, 255, 0); // l
    	          rgb_matrix_set_color(71, 0, 255, 0); // ;
	      }
	      if (fj_light) {
    	          rgb_matrix_set_color(65, 255, 255, 255); // f
    	          rgb_matrix_set_color(68, 255, 255, 255); // j
              }
            }
    	    rgb_matrix_set_color(73, 255, 255, 255);   // enter
    	    rgb_matrix_set_color(94, 255, 0, 0);       // left ctrl
    	    rgb_matrix_set_color(95, 0, 255, 255);     // left option
    	    rgb_matrix_set_color(96, 75, 199, 255);    // left command
    	    //rgb_matrix_set_color(97, 255, 255, 255);   // space
    	    rgb_matrix_set_color(98, 75, 199, 255);    // right command
    	    rgb_matrix_set_color(99, 0, 255, 255);     // right option
    	    rgb_matrix_set_color(100, RGB_ORANGE);     // fn 
    	    rgb_matrix_set_color(101, 255, 0, 0);      // right control
        }
        // if layer locked, turn the lock key white
        if (is_layer_locked(FN_LAYER) || is_layer_locked(CTL_LAYER) || is_layer_locked(OPT_LAYER) || is_layer_locked(SFT_LAYER)) {
    	    rgb_matrix_set_color(34, 255, 255, 255);   // ins (layer lock key)
        }	
        // if key lock is watching for next key, turn the key lock key red 
        if (is_key_lock_watching()) {
    	    rgb_matrix_set_color(13, RGB_ORANGE);   // screenshot (key lock key)
        }
        // if key lock is activated, turn the key lock key white
            ...
            if (is_key_lock_led_on) {
    	        rgb_matrix_set_color(13, 255, 255, 255);   // screenshot (key lock key)
            } 
            else {
    	        rgb_matrix_set_color(13, 255, 0, 0);   // screenshot (key lock key)
            }   
            // and light up normal modifiers if they are locked
            if (lcmd_locked) {
    	        rgb_matrix_set_color(96, 255, 255, 255);   // lcmd 
            }
            if (rcmd_locked) {
    	        rgb_matrix_set_color(98, 255, 255, 255);   // rcmd 
            }
            if (rsft_locked) {
    	        rgb_matrix_set_color(89, 255, 255, 255);   // rsft 
            }
            if (lsft_locked) {
    	        rgb_matrix_set_color(78, 255, 255, 255);   // lsft 
            }
            if (lctl_locked) {
    	        rgb_matrix_set_color(94, 255, 255, 255);   // lctl 
            }
            if (lopt_locked) {
    	        rgb_matrix_set_color(95, 255, 255, 255);   // lopt 
            }
        }
        // if leader is activated, flash the esc key red and white 
        if (is_in_leader_sequence) {
            ...
            if (is_leader_led_on) {
    	        ...
    	        rgb_matrix_set_color(101, 255, 255, 255);
            } 
            else {
    	        rgb_matrix_set_color(0, 255, 0, 0);
    	        rgb_matrix_set_color(101, 255, 0, 0);
            }   
        }
	...
	{
	    rgb_matrix_set_color(35, 255, 255, 255);   // home (fj highlight key)
	}
	if (layer == CTL_LAYER && hrow_light)
	{
	    rgb_matrix_set_color(56, 255, 255, 255);   // end (hrow highlight key)
	}
        // calculate the reactive rgb for keypresses
        for (int i = 0; i < tk_length; i++) {
            if (tracked_keys[i].press) {
                // esc, enter turn red 
                if (tracked_keys[i].index == 0 || tracked_keys[i].index == 73) {
...
bool key_should_fade(keytracker key, uint8_t layer) {
    ...
    if ((key.fade < 1) ||
       (key.index < 20) || 	                                                                      // top row
       (layer < 2 && key.index == 61) ||                                                              // caps lock 
       (key.index == 34 || key.index == 73) ||                                                        // ins, enter 
       ((key.index == 78 || key.index == 89) && (layer == 1 || layer == 3 || is_caps_word_on())) ||   // shift 
       (layer < 2 && key.index > 93 && key.index < 102) ||                                            // bottom row mods 
       (layer == 4 && (key.index == 94 || key.index == 101 || key.index == 35 || key.index == 56)) || // ctrl, home, end
       (layer == 5 && (key.index == 95 || key.index == 99))) {                                        // option
 	 should_fade = false;
       }
    return should_fade; 
}
...
void caps_finished (tap_dance_state_t *state, void *user_data) {
  ...
  switch (caps_tap_state.state) {
    case SINGLE_TAP: 
      tap_code(KC_CAPS); 
      // stop the key fade when caps lock is activated
      for (int i = 0; i < tk_length; i++) {
          if (tracked_keys[i].index == 61) {
              tracked_keys[i].press = false;
...
void dynamic_macro_record_end_user(int8_t direction) {
	...
	macro_recording = false;
        ...
        for (int i = 0; i < tk_length; i++) {
            if (tracked_keys[i].index > 15 && tracked_keys[i].index < 20) {
	        tracked_keys[i].press = false;
	        tracked_keys[i].fade = 0;
	    }
        }
