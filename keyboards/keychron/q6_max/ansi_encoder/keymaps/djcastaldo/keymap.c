...
//:|Esc | | F1 || F2 || F3 || F4 | | F5 || F6 || F7 || F8 | | F9 || F10|| F11|| F12| : Vol : |Snap||Siri||Glob| |DF13||DF14||Calc||Lock|:
...
//:| `  || 1  || 2  || 3  || 4  || 5  || 6  || 7  || 8  || 9  || 0  || -  || =  || Bkspace | |Ins ||Home||PgUp| |Num || /  || *  || D- |:
//:|____||____||____||____||____||____||____||____||____||____||____||____||____||_________| |____||____||____| |____||____||____||____|:
//:|LT(Tab)|| Q  || W  || E  || R  || T  || Y  || U  || I  || O  || P  || [  || ]  ||DYN_LT| |Del ||End ||PgDn| | 7  || 8  || 9  ||    |:
//:|_______||____||____||____||____||____||____||____||____||____||____||____||____||______| |____||____||____| |____||____||____|| +  |:
//:|TD(Caps)|| A  || S  || D  || F  || G  || H  || J  || K  || L  || ;  || '  || Enter     |                    | 4  || 5  || 6  ||    |:
//:|________||____||____||____||____||____||____||____||____||____||____||____||___________|        ____        |____||____||____||____|:
//:| Shift     || Z  || X  || C  || V  || B  || N  || M  || ,  || .  || /  || RSFT_TD      |       |Up  |       | 1  || 2  || 3  ||    |:
...
//:|____||____||____||____||____||____||____||____||____||____||____||____||____||_________| |____||____||____| |____||____||____||____|:
//:| Menu  ||QLok||Insp||Hide||    ||Time||    ||Btn1||MSUp||OHld||    ||    ||    ||OverVw| |FDel||TNxt||ANxt| |    ||    ||    ||    |:
//:|_______||____||____||____||____||____||____||____||____||____||____||____||____||______| |____||____||____| |____||____||____||    |:
...
//`-------------------------------------------------------------------------------------------------------------------------------------`
    [SFT_LAYR] = LAYOUT_109_ansi(
        _______,_______,_______,KC_MCTL,KC_LPAD,_______,_______,KC_MPRV,KC_MPLY,KC_MNXT,_______,_______,_______, ENC_APPHIDE,
        ...
        KC_APP,WM_QLOOK,WM_INSPECT,WM_VHIDDEN,_______,WM_TIME,_______,KC_MS_BTN1,KC_MS_UP,OPT_HOLD,_______,_______,_______,WM_OVIEW,
...
//`-------------------------------------------------------------------------------------------------------------------------------------`
    [MSYM_LAYR] = LAYOUT_109_ansi(
        ...
        _______,_______,_______,   _______,   TD(SUP_CYCLE),_______,_______,_______, _______,_______,_______, _______, _______, _______),
//  [WSYM_LAYR]
//,-------------------------------------------------------------------------------------------------------------------------------------,
//: ____   ______________________   ______________________   ______________________   ,---.   ________________   ______________________ :
//:|    | |SUP1||SUP2||SUP3||    | |SUTH||SUTD||SUTC||SUTS| |CRCI||    ||    ||NBSP| : Vol : |    ||    ||    | |    ||    ||    ||    |:
