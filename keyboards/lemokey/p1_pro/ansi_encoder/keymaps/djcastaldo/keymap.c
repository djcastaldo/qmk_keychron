...
//  : | LShift          || Z    || X    || C    || V    || B    || N    || M    || ,    || .    || /    ||RSFT_TD    | | Up   |         :
...
//  `-----------------------------------------------------------------------------------------------------------------------------------`
    [WIN_BASE] = LAYOUT_ansi_82(
        ...
        KC_LSFT,            KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,  KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_TD,      KC_UP,
...
//  `-----------------------------------------------------------------------------------------------------------------------------------`
    [MAC_BASE] = LAYOUT_ansi_82(
        ...
        TD(CAPS_LAYR),  KC_A,   KC_S,   KC_D,   KC_F,   KC_G,   KC_H,   KC_J,    KC_K,  KC_L,  KC_SCLN, KC_QUOT,      KC_ENT,   KC_PGDN,
        KC_LSFT,            KC_Z,   KC_X,   KC_C,   KC_V,   KC_B,   KC_N,  KC_M, KC_COMM, KC_DOT, KC_SLSH, RSFT_TD,      KC_UP,
        KC_LCTL, TD(LOPT_OSL), KC_LCMD,              KC_SPC,               TD(RCMD_OSL), OSL_FNSYM, KC_RCTL, KC_LEFT, KC_DOWN, KC_RGHT
    ),
...
//  `-----------------------------------------------------------------------------------------------------------------------------------`
    [FN_LAYR] = LAYOUT_ansi_82(
        ...
        MO(SFT_LAYR),_______,SECRET10,SECRET11,SECRET12,SECRET13,_______,_______, DM_PLY1, DM_PLY2, KC_PAUS, MO(SFT_LAYR), _______,
...
//  : |_____________||______||______||______||______||______||______||______||______||______||______||______||_______________:.|______| :
//  : |                 ||MSAcl2||      ||      ||      ||      ||      ||  P1  ||  P2  ||  P3  ||Statbr||  LClick   | | MSUp |         :
//  : |_________________||______||______||______||______||______||______||______||______||______||______||___________:.|______| ______  :
...
//  `-----------------------------------------------------------------------------------------------------------------------------------`
    [KCTL_LAYR] = LAYOUT_ansi_82(
        ...
        _______, BT_HST1, BT_HST2, BT_HST3, P2P4G, _______,_______,_______,_______, _______,_______, _______, _______, _______, CSTMTOG,
...
//  `-----------------------------------------------------------------------------------------------------------------------------------`
    [WSYM_LAYR] = LAYOUT_ansi_82(
        _______,  SUP1,  SUP2,  SUP3, _______,    SUITH, SUITD, SUITC, SUITS,      CIRCLI, _______, _______, NBSP,   LLOCK, ENC_UNIMENU,
        ...
        _______,    _______,  _______,                  _______,               TD(SUP_CYCLE),_______,_______, _______, _______, _______
    ),
