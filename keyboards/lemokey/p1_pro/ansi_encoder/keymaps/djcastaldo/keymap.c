...
//  : |D_Esc |  | F1   || F2   || F3   || F4   |  | F5   || F6   || F7   || F8   |  | F9   || F10  || F11  ||D_F12 |  | Home | : Vol  : :
...
//  `-----------------------------------------------------------------------------------------------------------------------------------`
    [BASE_LAYR] = LAYOUT_ansi_82(
        DUAL_ESC,  KC_F1, KC_F2, KC_F3,  KC_F4,  KC_F5,  KC_F6,  KC_F7,  KC_F8, KC_F9, KC_F10, KC_F11, DUAL_F12,  KC_HOME, ENC_DUALPUSH,
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    ...
    case FLASH_KB:
        if (record->event.pressed) {
           ...
           send_string("qmk flash -kb lemokey/p1_pro/ansi_encoder -km djcastaldo\n");
        }
        break;
    case BOOTLDR:
        if (record->event.pressed) {
